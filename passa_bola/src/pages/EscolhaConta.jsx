      ...
      <div className="w-full max-w-[420px] h-[100vh] md:h-auto flex flex-col justify-between bg-white p-10 rounded-lg shadow-md">
        ...
        <div className='w-full flex flex-col items-center justify-center'>
          ...
          <div className="flex justify-center gap-2 w-full">
            ...
            <button onClick={() => navigate('/re-fase-1')}className="flex-1 flex flex-col cursor-pointer items-center p-4 bg-gray-50 rounded-lg border border-gray-300 hover:border-blue-500 transition-all duration-200">
